...
class TestTelegramBot:
    ...
    async def test_alert_critical(self):
        ...
        await bot.alert_critical(title="Test Alert", message="This is a test", action="Action taken")
    ...
    async def test_alert_drawdown(self):
        ...
        await bot.alert_drawdown(
            current_drawdown=12.5, threshold=10.0, capital=8750.0, peak=10000.0, action_taken="Reduced positions"
        )
    ...
    async def test_alert_error(self):
        ...
        await bot.alert_error(error_type="API Error", error_msg="Connection failed")
    ...
    async def test_alert_daily_summary(self):
        ...
        await bot.alert_daily_summary(
            trades_today=10, win_rate=60.0, pnl_today=250.0, pnl_today_pct=2.5, total_capital=10250.0, open_positions=2
        )
